...
if __name__ == "__main__":
    ...
    print(trie.search("about"))  # True
    print(trie.get_autocompletion("d"))  # None
    print(trie.get_autocompletion("aar"))  # ["aaron", "aaron2"]
    print(trie.get_autocompletion("aaron2"))  # ["aaron2"]
    print(trie.get_autocompletion("aaron23"))  # None
